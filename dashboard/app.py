...
history store.
    ...
    NF_RUNINSIGHTS_HISTORY=s3-synced/dir python3 dashboard/app.py
...
All data logic lives in the shared module runinsights_store.py (also
used by mcp-server/server.py), this file is only the web door.
"""
